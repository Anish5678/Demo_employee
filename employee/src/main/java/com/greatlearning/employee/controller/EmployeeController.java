...
public class EmployeeController {
	...
	/*
	 * GET /employees - To list employees GET /employees/new - To add employee GET
	 * /employees/edit/{id} - To Edit employee POST /employees -- Save a new
	 * Employee POST /employees/{id} - Save Updated employee
